...
public:
	...
	*	@param showing_cursor Indicates if the turtle using this function was visible or not.
	*/
...
protected:
	...
	*/
	...
	bool showing_cursor;/**< Indicates if the turtle using this function was visible or not.*/
};
